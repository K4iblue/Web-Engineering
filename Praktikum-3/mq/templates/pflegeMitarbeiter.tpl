   ...
   <style> @import "/style.css"; </style>
	...
	<body>
		<div class="container">	
			...
			<div class="item-main">
				<div id="ueberschrift">Pflege Mitarbeiter</div>
				<table id="overview">
					<tr>
         			...
         			<tr>
            			...
            			<td>
               				<a href="/editmitarbeiter/${key_s}" id="buttons">bearbeiten</a>                   
               				<a href="/deletemitarbeiter/${key_s}" class="clDelete" id="buttons">löschen</a>
							<a href="/anzeigemitarbeiter/${key_s}" id="buttons">anzeigen</a>
            			</td>
         			</tr>
         			% endfor
				</table>
				<div>
         			<a href="/addmitarbeiter" id="erfassen">erfassen</a> 
      			</div>
			</div>
		</div>
	</body>
