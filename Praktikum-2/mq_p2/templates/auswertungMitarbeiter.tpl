   ...
   <style> @import "/style.css"; </style>
	...
	<body>
		<div class="container">	
			...
			<div class="item-main">
				<div id="ueberschrift">Mitarbeiter-Auswertung</div>
				<table id="overview">
					<tr>
            			<th>Name</th><th>Vorname</th><th>akademischer Grad</th><th>Tätigkeit</th><th>Aktion</th>
         			</tr>
					% for key_s in data_m:
         			<tr>
						...
						<td>
							<a href="/anzeigeauswertungmitarbeiter/${key_s}" id="buttons">anzeigen</a>
            			</td>
         			</tr>
					%endfor
				</table>
