...
#----------------------------------------------------------
	...
	#-------------------------------------------------------
		datum = date.today()
		markup_html = ""
		markup_html += self.create_p('header.tpl', data_opl)
		markup_html += self.create_p('sidebar.tpl', data_opl)
	...
	#-------------------------------------------------------
		markup_s = ''
		markup_s += self.create_p('header.tpl', data_opl)
		markup_s += self.create_p('sidebar.tpl', data_opl)
	...
	#-------------------------------------------------------
		markup_s = ''
		markup_s += self.create_p('header.tpl', data_opl, id_spl)
		markup_s += self.create_p('sidebar.tpl', data_opl, id_spl)
	...
	#-------------------------------------------------------
		markup_s = ''
		markup_s += self.create_p('header.tpl', None, id_spl)
		markup_s += self.create_p('sidebar.tpl', None, id_spl)
	...
	#-------------------------------------------------------
		datum = date.today()
		markup_s = ''
		markup_s += self.create_p('header.tpl', datas_opl[0], id_spl)
		markup_s += self.create_p('sidebar.tpl', datas_opl[0], id_spl)
	...
	#-------------------------------------------------------
		markup_s = ''
		markup_s += self.create_p('header.tpl', datas_opl)
		markup_s += self.create_p('sidebar.tpl', datas_opl)
	...
	#--------------------------------------------------------
		markup_s = ''
		markup_s += self.create_p('header.tpl', None)
		markup_s += self.create_p('sidebar.tpl', None)
